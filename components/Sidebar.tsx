...
const Sidebar = ({ user }: { user: any }) => {
  ...
  return (
    <div className="hidden md:block w-[20%] h-fit border border-gray-30000 bg-white rounded-md">
      <div className="flex relative flex-col items-center">
        ...
        <div className="border-b border-b-gray-300">
          <div className="p-2 mt-5 text-center">
            ...
            <p className="text-xs">
              @{user ? `${user?.externalAccounts[0]?.username}` : "username"}
            </p>
          </div>
        </div>
      </div>
      <div className="text-xs m-2">
        <div className="w-full flex justify-between items-center py-2 hover:bg-gray-200">
          <p>Post Impression</p>
          <p className="text-blue-600">99</p>
        </div>
        <div className="w-full flex justify-between items-center py-2 hover:bg-gray-200">
          <p>Posts</p>
